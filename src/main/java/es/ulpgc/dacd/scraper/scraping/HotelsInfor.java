...
public class HotelsInfor implements Ubi,Services,Comments,Ratings{
    ...
    @Override
    public void getRatings(String href) throws IOException {
        Document doc = Jsoup.connect(href).get();
    ...
    @Override
    public void getServices(String href) throws IOException {
        Document doc = Jsoup.connect(href).get();
    ...
    @Override
    public void getUbi(String href) throws IOException {
        Document doc = Jsoup.connect(href).get();
